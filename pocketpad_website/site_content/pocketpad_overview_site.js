    ...
    slides: [
      {
        ...
        alt: "Full console-style gamepad with floating joysticks and double-tap stick click",
        caption: "",
      },
      {
        src: "assets/screenshots/02_custom_skins.png",
        alt: "Sleek custom skins — switch between Silver and Gold controller themes",
        caption: "",
      },
      {
        src: "assets/screenshots/02b_custom_skins_3in1.png",
        alt: "Custom skins showcase with multiple PocketPad controller themes",
        caption: "",
      },
      {
        src: "assets/screenshots/03_tilt_to_steer.png",
        alt: "Tilt-to-steer controls for racing and driving games",
        caption: "",
      },
      {
        src: "assets/screenshots/04_layout_editor.png",
        alt: "Layout editor for rearranging and customizing on-screen controls",
        caption: "",
      },
      {
        src: "assets/screenshots/05_pc_keyboard.png",
        alt: "Full PC keyboard with shortcuts and a mobile-friendly typing layout",
        caption: "",
      },
      {
        src: "assets/screenshots/06_mousepad.png",
        alt: "Large mousepad / touchpad mode for pointer and desktop navigation",
        caption: "",
      },
      {
        src: "assets/screenshots/07_tv_remote.png",
        alt: "TV and media remote layout for playback and navigation",
        caption: "",
      },
      {
