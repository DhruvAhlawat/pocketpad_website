...
Site path: downloads/ — linked from the PocketPad overview (apps/pocketpad/)
...
ViGEmBus is required for virtual Xbox-controller injection — follow the Companion README in the mobile_gamepad repository.
